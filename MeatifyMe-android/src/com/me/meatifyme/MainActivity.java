...
public class MainActivity extends AndroidApplication implements ActionResolver,OnClickListener, OnCheckedChangeListener{
	...
	protected Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            case SHOW_NIVEIS:
            	if(!niveis_set){
	            	//niveis campanha
	            	Spinner spinner = (Spinner) niveis_view.findViewById(R.id.spinnerNiveisCampanha);
	        		ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(niveis_view.getContext(), android.R.layout.simple_spinner_item, maingame.nomes_levels);
	        		spinner.setAdapter(spinnerArrayAdapter);
	        		
	        		//niveis custom
	            	Spinner spinner2 = (Spinner) niveis_view.findViewById(R.id.spinnerNiveisCustom);
	        		ArrayAdapter<String> spinnerArrayAdapter2 = new ArrayAdapter<String>(niveis_view.getContext(), android.R.layout.simple_spinner_item, maingame.nomes_levels_custom);
	...
	public void onClick(View arg0) {
		...
		case R.id.btnPlayNiveis:
			handler.sendEmptyMessage(HIDE_MAINMENU);
			Spinner spinner = (Spinner) niveis_view.findViewById(R.id.spinnerNiveisCampanha);
			maingame.startLevel(spinner.getSelectedItemPosition());
			break;
