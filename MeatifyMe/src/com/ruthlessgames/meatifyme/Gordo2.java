...
public class Gordo2 extends Image implements Player{
	int xi,yi,xf,yf;
	int blocos[][];
	int moves = -1;
	...
	private void andar()
	{
		...
		andar.addAction(Actions.run(new Runnable(){
			...
			public void run() {
				// TODO Auto-generated method stub
				setDrawable(new TextureRegionDrawable(new TextureRegion(Textures.pl2_andar)));
		...
		andar.addAction(Actions.run(new Runnable(){
			...
			public void run() {
				// TODO Auto-generated method stub
				setDrawable(new TextureRegionDrawable(new TextureRegion(Textures.pl2_main)));
	...
	private void subir1(){
		...
		subir1.addAction(Actions.run(new Runnable(){
			...
			public void run() {
				// TODO Auto-generated method stub
				setDrawable(new TextureRegionDrawable(new TextureRegion(Textures.pl2_subir1_1)));
		...
		subir1.addAction(Actions.run(new Runnable(){
			...
			public void run() {
				// TODO Auto-generated method stub
				setDrawable(new TextureRegionDrawable(new TextureRegion(Textures.pl2_subir1_2)));
	...
	private void descer1(){
		...
		descer.addAction(Actions.parallel(Actions.moveBy(0, -MeatifyMe.bHeight),Actions.run(new Runnable(){

			@Override
			public void run() {
				// TODO Auto-generated method stub
				setDrawable(new TextureRegionDrawable(new TextureRegion(Textures.pl2_descer1_1)));
			}})));
		...
		descer.addAction(Actions.run(new Runnable(){
			...
			public void run() {
				// TODO Auto-generated method stub
				setDrawable(new TextureRegionDrawable(new TextureRegion(Textures.pl2_descer1_2)));
				Sounds.pl2_descer.play();
			}}));
		descer.addAction(Actions.delay(0.5f));
		descer.addAction(Actions.parallel(Actions.moveBy(MeatifyMe.bWidth,0),Actions.run(new Runnable(){
